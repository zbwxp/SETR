...
class vit_rand_4x_down(VisionTransformerUpHead):
    ...
    def __init__(self,
                 ...
                 num_ziper_layer=3,
                 **kwargs):
        super(vit_rand_4x_down, self).__init__(**kwargs)
    ...
    def forward(self, x):
        ...
        x_orig = x
        out = []
        idx_full = torch.randint(0, 1024, (1024,))
        for i in range(4):
            # pick rand token
            idx = idx_full[256 * i: 256 * (i + 1)]
            x = x_orig[:, idx]
