...
class vit_seq_clean_with_norm_single(VisionTransformerUpHead):
    ...
    def __init__(self,
                 ...
                 num_heads=12,
                 **kwargs):
        super(vit_seq_clean_with_norm_single, self).__init__(**kwargs)
        ...
        self.single_decoder = nn.TransformerDecoder(decoder_layer, num_expand_layer, norm=down_norm)
