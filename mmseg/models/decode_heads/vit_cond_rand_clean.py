...
class vit_cond_rand_clean(VisionTransformerUpHead):
    ...
    def __init__(self,
                 ...
                 use_scalar=False,
                 **kwargs):
        super(vit_cond_rand_clean, self).__init__(**kwargs)
    ...
    def forward(self, x):
        ...
        down_x = torch.stack([x_[id_] for x_, id_ in zip(x, learned_idx)])
