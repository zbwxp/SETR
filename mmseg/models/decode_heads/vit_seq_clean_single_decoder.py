...
class vit_seq_clean_single_decoder(VisionTransformerUpHead):
    ...
    def __init__(self,
                 ...
                 num_heads=12,
                 **kwargs):
        super(vit_seq_clean_single_decoder, self).__init__(**kwargs)
        ...
        self.single_decoder = nn.TransformerDecoder(decoder_layer, num_expand_layer)
