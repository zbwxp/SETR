...
class vit_seq_head_pos_sincos_convdownup(VisionTransformerUpHead):
    ...
    def __init__(self,
                 ...
                 num_expand_layer=3,
                 **kwargs):
        super(vit_seq_head_pos_sincos_convdownup, self).__init__(**kwargs)
        ...
        self.down = nn.Conv2d(hidden_dim, hidden_dim,
