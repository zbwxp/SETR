...
class Vit_vt_hourglass_res(VisionTransformer):
    ...
    def __init__(self,
                 ...
                 expand_index=11,
                 **kwargs):
        super(Vit_vt_hourglass_res, self).__init__(**kwargs)
        ...
        res_token_layer = FilterTokenizer(
            in_channels=kwargs['embed_dim'],
            token_channels=kwargs['embed_dim'],
            tokens=int(VT_query * 4),
        )
        ...
        self.res_token = res_token_layer
