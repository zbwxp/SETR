...
from .mix_transformer import OverlapPatchEmbed
...
class Vit_pos(VisionTransformer):
    """ Vision Transformer with support for patch or hybrid CNN input stage
    """

    def __init__(self,
                 **kwargs):
        super(Vit_pos, self).__init__(**kwargs)
        self.patch_embed1 = OverlapPatchEmbed(patch_size=3, stride=1,
