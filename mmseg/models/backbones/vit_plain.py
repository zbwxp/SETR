...
class vit_plain(VisionTransformer):
    ...
    def __init__(self,
                 ...
                 use_norm=True,
                 **kwargs):
        super(vit_plain, self).__init__(**kwargs)
        ...
        self.decoder = nn.TransformerDecoder(decoder_layer, num_expand_layer)
    ...
    def forward(self, x):
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if i == self.shrink_index:
                ...
                x = self.decoder(self.q.weight.repeat(bs, 1, 1).transpose(0, 1), x.transpose(0, 1))
                x = x.transpose(0, 1)
